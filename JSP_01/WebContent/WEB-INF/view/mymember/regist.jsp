...
<div class="register-box">
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1"><b>Spring&nbsp;</b>&nbsp;회원가입</a>
    </div>
    ...
    <form role="form" class="form-horizontal" action="regist.do" method="post">
        ...
        <label for="pwd" class="col-sm-3 mainText" style="font-size:0.9em;">
          ...
          <input type="password" class="form-control" placeholder="20글자 영문자,숫자,특수문자 조합">
          <div class="input-group-append">
		...
		<div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-block btn-outline-primary btn-sm">등록</button>
            <button type="button" class="btn btn-block btn-outline-secondary btn-sm">취소</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
