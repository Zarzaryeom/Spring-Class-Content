...
public class TestController {
	...
	public String test(@RequestParam("message")String messa, Model model) {
		String url = "test/main";
	...
	public String testParam(@RequestParam(name="message",defaultValue="Nice day!!!")String messa, Model model) {
		String url = "test/main";
		model.addAttribute("message", messa);
		return url;
	}
	...
	public String test4Param(MemberVO member) {
