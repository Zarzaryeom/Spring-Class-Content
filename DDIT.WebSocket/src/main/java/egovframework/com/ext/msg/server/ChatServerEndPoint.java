...
/*
 * configurator = ChatServerAppConfig.class : 웹소켓 EndPoint 에서 서비스를 호출 하고자 할 경우 선언 필수 
 * 
 */
// {room} 아이디가 계속 바뀌면서 1:1 채팅만 가능해짐
...
public class ChatServerEndPoint {
	 ...
	 * Handshaking 함수
	 *
	 * front : \webapp\WEB-INF\jsp\egovframework\com\ext\msg\popup\chatPopupBubble.jsp
	 *
